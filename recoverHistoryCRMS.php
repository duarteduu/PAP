...
if (isset($_POST['id'])){
    ...
    if ($result->num_rows  < 1){
        ...
        $sql = "UPDATE crms SET concluida=0 WHERE id=$id;";
        $conn->query($sql);
...
<head>
    ...
    <title>Recuperar CRMS</title>
</head>
<body>
<div id="interface-form">
    <div id="header-text">
        Recuperar registo CRM
        <hr/>
    </div>
    <div id="interface-form">
        <p style="font-size: 30px; margin-top: 50px; text-align: center;">CRM do cliente: <strong><?php echo $_GET['name']; ?></strong></p>
        <form method="post">
